// Program  : Bubbles
// Objective: Droplets Characterisation

// Author   : Dr Zeeshan Rana and Ms Magdalena Malon; zeeshan.rana@cranfield.ac.uk
// Copyright: 2017 School of Aerospace, Transport and Manufacturing, Cranfield University
// No part of this program can be used or reproduced for commercial benefits withour explicit permission from Dr Zeeshan Rana and Cranfield University. 

// Programme uses the Cascade Classifier (file with xml extension) to automatically detect droplets on images. 
// When droplets are detected user can remove wrongly detected droplets or add droplets that are not deteted.

//***** Removing droplets:
// right mouse button to choose droplet that should be removed
// click "e" button on keyboard to remove the droplet

//***** Adding droplets
// left mouse button to choose three points on the circumference of the droplet
// click "d" button on keyboard to draw the droplet

// ***** To refresh the image click "r" button

// ***** "n" button to go to the next image

//****** OUTPUT OF THE PROGRAMME
//Programme creates two text files which contains information about calibration factor, diameters of droplets, number of all droplets.
// Programme also saves images with marked droplets


// USAGE: To run the programme type following parameters in command window:
//1. Name of Programme (bubbles)
//2. Calibration factor in mikrometers/pixel (for example if you have 0.2 mikrometers/pixel type 0.2)
//3. output folder (you should create it first)
//4. name of Cascade Classifier
//5. path\to\images/*jpg
